OIS_scraper_cleaner <- function(dataset_name){
  ...
  if (dataset_name == "austin_OIS_2000_2014") {
    ...
    austin_OIS_2000_2014$Officer.Name <- gsub("^.* (.* .*)$", "\\1",
                                              austin_OIS_2000_2014$Officer.Name)
    ...
    austin_OIS_2000_2014$department_name <- "austin_police"
  ...
  if (dataset_name == "austin_OIS_2006_2015"){
    ...
    names(austin_OIS_2006_2015) <- gsub(",|\\.", "_",
                                        names(austin_OIS_2006_2015))


    austin_OIS_2006_2015$rank <- gsub("ofc", "officer",
                                      austin_OIS_2006_2015$rank)
    austin_OIS_2006_2015$rank <- gsub("det", "detective",
                                      austin_OIS_2006_2015$rank)
    ...
    austin_OIS_2006_2015$rank <- gsub("other agency - ofc",
                                      "offer_from_different_department",
                                      austin_OIS_2006_2015$rank)
    austin_OIS_2006_2015$rank <- gsub("sgt", "sergeant",
                                      austin_OIS_2006_2015$rank)
    austin_OIS_2006_2015$officer_name <- gsub("^.* (.* .*)$", "\\1",
                                              austin_OIS_2006_2015$officer_name)

    austin_OIS_2006_2015$department_name <- "austin_police"
  ...
  if (dataset_name == "dallas_OIS"){
    ...
    dallas_OIS$department_name <- "dallas_police"
  ...
  if (dataset_name == "hampton_OIS"){
    ...
    hampton_OIS$date <- gsub("AM|PM", "", hampton_OIS$date)
    hampton_OIS$date <- mdy_hms(hampton_OIS$date)
    ...
    hampton_OIS$department_name <- "hampton_police"
  ...
  if (dataset_name == "hartford_OIS"){
    ...
    hartford_OIS$department_name <- "hartford_police"
  ...
  if (dataset_name == "indianapolis_OIS"){
    ...
    indianapolis_OIS$department_name <- "indianapolis_police"
  ...
  if (dataset_name == "LA_OIS_people"){
    ...
    LA_OIS <- merge(LA_OIS_1, LA_OIS_2, by = c("INCIDENT.NUMBER"),
                    suffixes = "zz")
    LA_OIS <- merge(LA_OIS, LA_OIS_5, by = c("INCIDENT.NUMBER"),
                    suffixes = "zz")
    LA_OIS <- merge(LA_OIS, LA_OIS_6, by = c("INCIDENT.NUMBER"),
                    suffixes = "zz")
  ...
  LA_OIS_people$involved_in_previous_shootings <- gsub("n", 0,
    ...
    LA_OIS_people$department_name <- "LA_county_sheriff"
  ...
  if (dataset_name == "LA_OIS_animal"){
    ...
    LA_OIS_animal$department_name <- "LA_county_sheriff"
  ...
  if (dataset_name == "philadelphia_OIS"){
    ...
    philadelphia_OIS$longitude <- gsub(".*(\\-.*) .*", "\\1",
                                       philadelphia_OIS$Shape)
    philadelphia_OIS$latitude <- gsub(".* (.*)", "\\1",
                                      philadelphia_OIS$Shape)
    philadelphia_OIS$latitude <- gsub(".$", "", philadelphia_OIS$latitude)
    philadelphia_OIS$SHAPE <- NULL
    philadelphia_OIS$Date <- mdy_hms(philadelphia_OIS$Date)
    philadelphia_OIS$date <- philadelphia_OIS$Date
    philadelphia_OIS$Date <- paste(philadelphia_OIS$Date,
                                    philadelphia_OIS$Time,
                                    sep = " ")
    philadelphia_OIS$date_time <- ymd_hm(philadelphia_OIS$Date)
    philadelphia_OIS$Date <- NULL
    ...
    philadelphia_OIS$dc_key <- as.numeric(philadelphia_OIS$dc_number)
    ...
    philadelphia_OIS$subject_latino <- gsub(-1, 1,
                                            philadelphia_OIS$subject_latino)
    ...
    philadelphia_OIS$department_name <- "philadelphia_police"
  ...
  if (dataset_name == "tucson_OIS"){
    ...
    tucson_OIS$department_name <- "tucson_police"
